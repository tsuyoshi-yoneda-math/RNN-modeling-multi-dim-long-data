...
As shown in Reservoir3setsScheme_MultiDimLongData.ipynb, the <b>1000-step-ahead prediction (nondimensional time of 10) achieves a MAE of 0.014</b> (for the standardized dataset), computed as the mean error over the entire prediction horizon.
